...
RUN DEBIAN_FRONTEND=noninteractive addgroup --gid 100 appgroup && \
    DEBIAN_FRONTEND=noninteractive useradd -m -d /usr/share/app -s /usr/sbin/nologin -g app -u 99 appgroup && \
